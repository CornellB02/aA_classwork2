...
console.log(lastChar); // 23
console.log(sentence.indexOf(lastChar)); // -1
...
// // 5
let age = 31; // try different numbers here
if (age > 30) {
...
// // 8
 num = 15; // try different numbers here
if (num % 3 === 0) {
  console.log('divisible by 3');
}
if (num % 5 === 0) {
...
// // 9
// let str = 'App AcademY'; // try different strings here
